...
| Concepts catalogued | 1508 (`data/concepts.tsv`) |
| Lexicon forms minted | 1487 roots (`data/lexicon.tsv`) — **every catalogued root covered, 0 gaps** |
| Derived dictionary | 10838 affix-derived (`data/derived-lexicon.tsv`) + 34 curated compounds (`data/compounds.tsv`), all generated — **12359 total entries** |
| Both gates | green (linter R1–R6 + collision checker); roots 1487/1487 + derived 10838/10838 + compounds 34/34 clear, exit 0 |
