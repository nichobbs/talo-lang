...
| Phase in progress | **7 — reading-coverage lexicon scaling** (`0013`): extend the ~1,500 cutoff to a **coverage-defined target** (≥98 % of a cleaned reference, interim 95 %; converges ~3,500–4,500 roots) via concerted frequency-anchored minting + corpus validation. **v1.0 freeze checklist fully green** (`0011` §5.1, all gates closed incl. the native-speaker screen pass); 1.0 declarable. |
