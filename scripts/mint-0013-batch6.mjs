// 0013 Batch 6 — first reading-coverage minting batch. Genuine IDS-spine root
...
//   Run: node --experimental-strip-types scripts/mint-0013-batch6.mjs
...
const NEW = [
  // tech / abstract gaps from the "self-healing software" article
  ["MOD","system",2,"n","xitong","Sinitic"],
  ["MOD","pattern",2,"n","corak","Austronesian"],
  ["MOD","fault / defect",2,"n","cacat","Austronesian"],
  ["ACT","control / manage",2,"v","kendali","Austronesian"],
  ["ACT","prevent",2,"v","cegah","Austronesian"],
  ["ACT","disrupt / disturb",2,"v","ganggu","Austronesian"],
  ["ACT","fail / failure",2,"v","gagal","Austronesian"],
  ["SOC","responsibility / accountability",2,"n","jukumu","Bantu"],
  ["SOC","service (provided)",2,"n","layanan","Austronesian"],
  ["COG","model / example",2,"n","contoh","Austronesian"],
  ["COG","risk",2,"n","risiko","Austronesian"],
];
...
for (const [domain, gloss, tier, pos, src, family] of NEW) {
  ...
  newConRows.push([id, gloss, domain, String(tier), pos, "yes", "", "IDS", "0013 batch6 (" + family + ")"].join("\t"));
