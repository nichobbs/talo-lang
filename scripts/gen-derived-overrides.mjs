...
// More verbs with a genuine person-agent noun (avoids device homographs like
// flow->"flower", rub->"rubber", count->"counter", open->"opener").
Object.assign(AGENT, {analyze:"analyst",arrange:"arranger",ask:"questioner",bathe:"bather",begin:"beginner",believe:"believer",borrow:"borrower",break:"breaker",broadcast:"broadcaster",bury:"undertaker",call:"caller",carry:"carrier",chase:"pursuer",collect:"collector",cut:"cutter",decorate:"decorator",dig:"digger","do":"maker / doer",drill:"driller",dye:"dyer",earn:"earner",examine:"examiner",find:"finder",flee:"fugitive",gather:"gatherer",hate:"hater",hit:"hitter",imitate:"imitator",install:"installer",interpret:"interpreter",investigate:"investigator",lend:"lender",lift:"lifter",listen:"listener","look at":"watcher / observer",move:"mover",navigate:"navigator",negotiate:"negotiator",pack:"packer",plan:"planner",plough:"ploughman",polish:"polisher",push:"pusher",rebel:"rebel",search:"searcher / seeker",sit:"sitter",sleep:"sleeper",sow:"sower",spend:"spender",spin:"spinner",store:"storekeeper",study:"student / scholar",suffer:"sufferer",survive:"survivor",suspect:"suspect",sweep:"sweeper",taste:"taster",think:"thinker",translate:"translator",turn:"turner",type:"typist",use:"user",wait:"waiter",wander:"wanderer",wear:"wearer",weld:"welder"});
for (const k of ["flow","rub","have","want","know","lie down","obey","wrap"]) AGENT_SUPPRESS.add(k);
Object.assign(AGENT, {shelter:"protector", control:"controller / manager"}); // 0013 batch5 new roots
Object.assign(AGENT, {protect:"protector / guardian", test:"tester", diagnose:"diagnostician"}); // medical batch
for (const k of ["harm","decline"]) AGENT_SUPPRESS.add(k); // no "harmer"/"decliner"
...
const RESULT = {build:"building",write:"writing / document",give:"gift",ask:"question",cook:"dish / cooked food",buy:"purchase / goods",draw:"drawing",paint:"painting",say:"statement",answer:"answer",pay:"payment",promise:"promise",diagnose:"diagnosis",harm:"harm / damage (n)",decline:"decline / deterioration"};
